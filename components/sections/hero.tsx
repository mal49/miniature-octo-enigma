export function Hero() {
  return (
    <section id="hero" className="bg-white border-b-2 border-black">
      <div className="mx-auto max-w-5xl px-6 py-16 md:py-24 flex flex-col md:flex-row items-center gap-10 md:gap-16">
        {/* Left: Text content */}
        <div className="flex-1 min-w-0">
          <h1 className="text-[4.5rem] md:text-[6rem] font-black leading-[0.88] tracking-tight mb-7">
            Hello.
            <br />
            I&apos;m Ikhmal.
          </h1>
          ...
          <a
            href="#projects"
            className="inline-block border-2 border-black px-6 py-3 text-sm font-bold hover:bg-black hover:text-white transition-colors duration-150">
            Clone me on GitHub
          </a>
        </div>

        {/* Right: Retro illustration */}
        <div className="flex-shrink-0 w-52 h-60 md:w-72 md:h-80">
          <RetroIllustration />
        </div>
      </div>
    </section>
